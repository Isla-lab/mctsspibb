...
def policy_comparison():
    ...
    real_T, R, optimal, baseline, garnet, final_states, path = load_env_and_policies_sysadmin(n_machines, discount_factor)
    ...
    for nb_trajectories in nb_trajectories_list:
        ...
        save_object(perf_mcts, 'out/SysAdmin/results/v0_delta_spibb_mcts_trj_%s_it_%s.pkl' % (nb_trajectories, it))
