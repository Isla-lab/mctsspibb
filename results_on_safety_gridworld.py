...
def policy_comparison(size):
    ...
    for nb_trajectories in nb_trajectories_list:
        ...
        save_object(perf_spibb, 'out/GridWorld/results/v0_spibb_trj_%s_it_%s.pkl' % (nb_trajectories, it))
        save_object(perf_mcts, 'out/GridWorld/results/v0_mcts_trj_%s_it_%s.pkl' % (nb_trajectories, it))
